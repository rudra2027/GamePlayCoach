...
public class q3 {
    ...
    public static void main(String[] args) {
    	 Trader t1 = new Trader("mdnfbf", "Bangalore");
         Trader t2 = new Trader("kfjnkfdv", "Pune");
         Trader t3 = new Trader("fkjnvfd", "Bangalore");
         Trader t4 = new Trader("jnnvnd", "Delhi");
         Trader t5= new Trader("vnd fvmn ", "Chennai");
         Trader t6 = new Trader("kjdfkjfk", "Pune");
         Trader t7 = new Trader("adarsh", "Delhi");
         Trader t8 = new Trader("fnfjbhdga", "Delhi");
         Trader t9 = new Trader("dvdbcds", "Pune");
         ...
         System.out.println(allTraderNames(traders));
         System.out.println(areAnyTradersFromIndore(traders1));
     }
    }
}
